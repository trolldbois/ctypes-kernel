...
class ctl_table(Structure):
    pass
proc_handler = CFUNCTYPE(c_int, POINTER(ctl_table), c_int, c_void_p, POINTER(size_t), POINTER(loff_t))
...
class N11desc_struct4DOT_21E(Union):
    pass
class N11desc_struct4DOT_214DOT_22E(Structure):
    pass
N11desc_struct4DOT_214DOT_22E._fields_ = [
    ('a', c_uint),
    ('b', c_uint),
]
class N11desc_struct4DOT_214DOT_23E(Structure):
    pass
N11desc_struct4DOT_214DOT_23E._fields_ = [
    ('limit0', u16),
    ('base0', u16),
    ('base1', c_uint, 8),
    ('type', c_uint, 4),
...
N11desc_struct4DOT_21E._anonymous_ = ['_1', '_0']
N11desc_struct4DOT_21E._fields_ = [
    ('_0', N11desc_struct4DOT_214DOT_22E),
    ('_1', N11desc_struct4DOT_214DOT_23E),
]
desc_struct._pack_ = 1
desc_struct._anonymous_ = ['_0']
desc_struct._fields_ = [
    ('_0', N11desc_struct4DOT_21E),
]
...
class N8spinlock4DOT_37E(Union):
    pass
N8spinlock4DOT_37E._fields_ = [
    ('rlock', raw_spinlock),
]
spinlock._anonymous_ = ['_0']
spinlock._fields_ = [
    ('_0', N8spinlock4DOT_37E),
]
seqcount._fields_ = [
    ('sequence', c_uint),
]
...
class N4page4DOT_42E(Union):
    pass
class N4page4DOT_424DOT_43E(Structure):
    pass
N4page4DOT_424DOT_43E._fields_ = [
    ('inuse', u16),
    ('objects', u16),
]
N4page4DOT_42E._anonymous_ = ['_0']
N4page4DOT_42E._fields_ = [
    ('_mapcount', atomic_t),
    ('_0', N4page4DOT_424DOT_43E),
]
class N4page4DOT_44E(Union):
    pass
class N4page4DOT_444DOT_45E(Structure):
    pass
class address_space(Structure):
    pass
N4page4DOT_444DOT_45E._fields_ = [
    ('private1', c_ulong),
    ('mapping', POINTER(address_space)),
]
class kmem_cache(Structure):
    pass
N4page4DOT_44E._anonymous_ = ['_0']
N4page4DOT_44E._fields_ = [
    ('_0', N4page4DOT_444DOT_45E),
    ('ptl', spinlock_t),
    ('slab', POINTER(kmem_cache)),
    ('first_page', POINTER(page)),
]
class N4page4DOT_46E(Union):
    pass
N4page4DOT_46E._fields_ = [
    ('index', c_ulong),
    ('freelist', c_void_p),
]
...
class N7siginfo5DOT_121E(Union):
    pass
class N7siginfo5DOT_1215DOT_122E(Structure):
    pass
N7siginfo5DOT_1215DOT_122E._fields_ = [
    ('_pid', __kernel_pid_t),
    ('_uid', __kernel_uid32_t),
]
class N7siginfo5DOT_1215DOT_123E(Structure):
    pass
N7siginfo5DOT_1215DOT_123E._fields_ = [
...
class N7siginfo5DOT_1215DOT_124E(Structure):
    pass
N7siginfo5DOT_1215DOT_124E._fields_ = [
    ('_pid', __kernel_pid_t),
    ('_uid', __kernel_uid32_t),
    ('_sigval', sigval_t),
]
class N7siginfo5DOT_1215DOT_125E(Structure):
    pass
N7siginfo5DOT_1215DOT_125E._fields_ = [
    ('_pid', __kernel_pid_t),
    ('_uid', __kernel_uid32_t),
    ('_status', c_int),
...
class N7siginfo5DOT_1215DOT_126E(Structure):
    pass
N7siginfo5DOT_1215DOT_126E._fields_ = [
    ('_addr', c_void_p),
    ('_addr_lsb', c_short),
]
class N7siginfo5DOT_1215DOT_127E(Structure):
    pass
N7siginfo5DOT_1215DOT_127E._fields_ = [
    ('_band', c_long),
    ('_fd', c_int),
]
N7siginfo5DOT_121E._fields_ = [
    ('_pad', c_int * 29),
    ('_kill', N7siginfo5DOT_1215DOT_122E),
    ('_timer', N7siginfo5DOT_1215DOT_123E),
    ('_rt', N7siginfo5DOT_1215DOT_124E),
    ('_sigchld', N7siginfo5DOT_1215DOT_125E),
    ('_sigfault', N7siginfo5DOT_1215DOT_126E),
    ('_sigpoll', N7siginfo5DOT_1215DOT_127E),
]
siginfo._fields_ = [
    ('si_signo', c_int),
    ('si_errno', c_int),
    ('si_code', c_int),
    ('_sifields', N7siginfo5DOT_121E),
]
class N8sigevent5DOT_128E(Union):
    pass
class N8sigevent5DOT_1285DOT_129E(Structure):
    pass
N8sigevent5DOT_1285DOT_129E._fields_ = [
    ('_function', CFUNCTYPE(None, sigval_t)),
    ('_attribute', c_void_p),
]
N8sigevent5DOT_128E._fields_ = [
    ('_pad', c_int * 13),
    ('_tid', c_int),
    ('_sigev_thread', N8sigevent5DOT_1285DOT_129E),
]
sigevent._fields_ = [
    ('sigev_value', sigval_t),
    ('sigev_signo', c_int),
    ('sigev_notify', c_int),
    ('_sigev_un', N8sigevent5DOT_128E),
]
...
class i387_fxsave_struct(Structure):
    pass
class N18i387_fxsave_struct4DOT_30E(Union):
    pass
class N18i387_fxsave_struct4DOT_304DOT_31E(Structure):
    pass
N18i387_fxsave_struct4DOT_304DOT_31E._pack_ = 4
N18i387_fxsave_struct4DOT_304DOT_31E._fields_ = [
    ('rip', u64),
    ('rdp', u64),
]
class N18i387_fxsave_struct4DOT_304DOT_32E(Structure):
    pass
N18i387_fxsave_struct4DOT_304DOT_32E._fields_ = [
    ('fip', u32),
    ('fcs', u32),
    ('foo', u32),
    ('fos', u32),
]
N18i387_fxsave_struct4DOT_30E._anonymous_ = ['_1', '_0']
N18i387_fxsave_struct4DOT_30E._fields_ = [
    ('_0', N18i387_fxsave_struct4DOT_304DOT_31E),
    ('_1', N18i387_fxsave_struct4DOT_304DOT_32E),
]
...
i387_fxsave_struct._fields_ = [
    ...
    ('twd', u16),
    ('fop', u16),
    ('_0', N18i387_fxsave_struct4DOT_30E),
    ('mxcsr', u32),
    ('mxcsr_mask', u32),
    ('st_space', u32 * 32),
    ('xmm_space', u32 * 64),
    ('padding', u32 * 12),
    ('_1', N18i387_fxsave_struct4DOT_33E),
]
...
class restart_block(Structure):
    pass
class N13restart_block3DOT_8E(Union):
    pass
class N13restart_block3DOT_83DOT_9E(Structure):
    pass
N13restart_block3DOT_83DOT_9E._fields_ = [
    ('arg0', c_ulong),
    ('arg1', c_ulong),
    ('arg2', c_ulong),
    ('arg3', c_ulong),
]
class N13restart_block3DOT_84DOT_10E(Structure):
    pass
N13restart_block3DOT_84DOT_10E._pack_ = 4
N13restart_block3DOT_84DOT_10E._fields_ = [
    ('uaddr', POINTER(u32)),
    ('val', u32),
    ('flags', u32),
    ('bitset', u32),
...
class N13restart_block3DOT_84DOT_11E(Structure):
    pass
N13restart_block3DOT_84DOT_11E._pack_ = 4
N13restart_block3DOT_84DOT_11E._fields_ = [
    ('index', clockid_t),
    ('rmtp', POINTER(timespec)),
    ('expires', u64),
]
class N13restart_block3DOT_84DOT_12E(Structure):
    pass
class pollfd(Structure):
    pass
N13restart_block3DOT_84DOT_12E._fields_ = [
    ('ufds', POINTER(pollfd)),
    ('nfds', c_int),
    ('has_timeout', c_int),
    ('tv_sec', c_ulong),
...
N13restart_block3DOT_8E._anonymous_ = ['_0']
N13restart_block3DOT_8E._fields_ = [
    ('_0', N13restart_block3DOT_83DOT_9E),
    ('futex', N13restart_block3DOT_84DOT_10E),
    ('nanosleep', N13restart_block3DOT_84DOT_11E),
    ('poll', N13restart_block3DOT_84DOT_12E),
]
restart_block._anonymous_ = ['_0']
restart_block._fields_ = [
    ('fn', CFUNCTYPE(c_long, POINTER(restart_block))),
    ('_0', N13restart_block3DOT_8E),
]
...
class key_user(Structure):
    pass
class N3key5DOT_186E(Union):
    pass
N3key5DOT_186E._fields_ = [
    ('expiry', time_t),
    ('revoked_at', time_t),
]
class N3key5DOT_187E(Union):
    pass
N3key5DOT_187E._fields_ = [
    ('link', list_head),
    ('x', c_ulong * 2),
    ('p', c_void_p * 2),
]
class N3key5DOT_188E(Union):
    pass
class keyring_list(Structure):
    pass
N3key5DOT_188E._fields_ = [
    ('value', c_ulong),
    ('data', c_void_p),
...
key._fields_ = [
    ...
    ('flags', c_ulong),
    ('description', STRING),
    ('type_data', N3key5DOT_187E),
    ('payload', N3key5DOT_188E),
]
...
class N13math_emu_info4DOT_13E(Union):
    pass
class kernel_vm86_regs(Structure):
    pass
N13math_emu_info4DOT_13E._fields_ = [
...
class N14vm_area_struct4DOT_47E(Union):
    pass
class N14vm_area_struct4DOT_474DOT_48E(Structure):
    pass
N14vm_area_struct4DOT_474DOT_48E._fields_ = [
    ('list', list_head),
    ('parent', c_void_p),
...
N14vm_area_struct4DOT_47E._fields_ = [
    ('vm_set', N14vm_area_struct4DOT_474DOT_48E),
...
vm_area_struct._fields_ = [
    ...
    ('vm_flags', c_ulong),
    ('vm_rb', rb_node),
    ('shared', N14vm_area_struct4DOT_47E),
...
__all__ = ['__kernel_uid32_t', 'wait_queue_t', 'page_cgroup',
           ...
           '__kernel_size_t', '__s16', '__kernel_daddr_t', '__le64',
           'mmu_notifier_mm', 'cpumask_var_t', 'mqd_t', 'umode_t',
           'pcpu_fc_free_fn_t', 'tty_audit_buf', 'hrtimer_clock_base',
           'HRTIMER_NORESTART', 'timer_t', '__wait_queue',
           'task_cputime', 'thread_struct', 'timespec', '__le16',
           'hlist_head', 'N13restart_block3DOT_83DOT_9E',
           'N8sigevent5DOT_1285DOT_129E', 'N13restart_block3DOT_8E',
           'raw_spinlock_t', 'zoneref', 'N4page4DOT_42E', 'u32',
           'work_struct', 'va_list', 'group_info',
           'N13restart_block3DOT_84DOT_11E', 'vm_area_struct', 's16',
           'kernel_cap_t', 'taskstats', 'pgd_t', 'zone',
           '__kernel_sighandler_t', 'N7siginfo5DOT_1215DOT_127E',
           'user_struct', 'sighand_struct', 'key_type',
           ...
           'handler_t', 'rb_augment_f', 'u_int8_t', 'u64', 'off_t',
           's8', 'proc_handler', 'fpu', 'cpumask',
           'i387_fxsave_struct', 'wait_queue_func_t',
           'N3key5DOT_188E', 'nsproxy', 'signal_struct',
           ...
           'sigval', 'exec_domain', 'dma_addr_t', 'uid16_t',
           'zonelist_cache', 'key_ref_t', 'cred', 'upid',
           ...
           'N18i387_fxsave_struct4DOT_304DOT_32E', 'spinlock_t',
           'uint64_t', 'dma64_addr_t', '__kernel_ptrdiff_t',
           '__kernel_ipc_pid_t', 'perf_event_context', 'nlink_t',
           '__u8', 'pcpu_fc_cpu_distance_fn_t', '__s32',
           'xsave_struct', 'uint32_t', 'ulong', 'ymmh_struct',
           'sigevent_t', 'int8_t', 'pacct_struct',
           'revectored_struct', 'anon_vma', 'rb_root',
           'pipe_inode_info', 'dev_t', 'gfp_t', 'reclaim_state',
           'ktime', '__kernel_dev_t', 'gid16_t', 'mode_t',
           'completion', 'gid_t', '__kernel_mode_t', 'siginfo',
           ...
           'latency_record', 'blkcnt_t', 'free_area', 'ctl_table',
           'N4page4DOT_44E', 'key_user', 'u16', 'k_sigaction',
           'perf_event', 'pm_message', 'pollfd', 'raw_prio_tree_node',
           'physid_mask', 'N11desc_struct4DOT_214DOT_23E', 'u_long',
           'nodemask_t', 'pm_message_t', 'int64_t',
           ...
           'N7siginfo5DOT_1215DOT_123E', 'phys_addr_t', '__u64',
           'seccomp_t', '__user_cap_header_struct', 'futex_pi_state',
           'core_thread', 'suseconds_t', 'zonelist',
           'N13restart_block3DOT_84DOT_12E', 'HRTIMER_RESTART',
           ...
           '__be32', 'core_state', 'keyring_list',
           'thread_group_cputimer', 'prop_local_single',
           'zone_reclaim_stat', 'arch_spinlock_t',
           'N7siginfo5DOT_1215DOT_126E', '__wait_queue_head',
           'ptrdiff_t', '__kernel_key_t', 'css_set', 'load_weight',
           'vm86_regs', 'apm_event_t', 'task_struct', 'u8',
           ...
           'pcpu_fc_alloc_fn_t', '__kernel_timer_t', 'math_emu_info',
           'cputime64_t', 'N7siginfo5DOT_1215DOT_125E', 'pgprotval_t',
           'work_func_t', 'robust_list_head', 'per_cpu_pageset',
